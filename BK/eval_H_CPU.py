...
def parse_args(argv=None):
    ...
    #parser.add_argument('--images', default='./data/slab/H_P/ORIGINAL/21_10_23?RESULTIMAGES/output_images_H_21_10_23_TOP2', type=str,
    parser.add_argument('--images', default='./data/test?./output_images', type=str,

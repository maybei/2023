...
'''
slab_dataset = dataset_base.copy({
    'name': 'Immersive Limit - Slab',
    'train_info': './data/slab/train/train.json',
    'train_images': './data/slab/train/images/',
    'valid_info': './data/slab/val/val2.json',
    'valid_images': './data/slab/val/images/',
    'class_names': ('slab'),
    'label_map': {1: 1}
})
'''
...
slab_dataset = dataset_base.copy({
    'name': 'Immersive Limit - Slab',
    'train_info': './data/H_slab/DS/train/DS_TRAIN_400.json',
    'train_images': './data/H_slab/DS/train/images/',
    'valid_info': './data/H_slab/DS/valid/DS_VALID_100.json',
    'valid_images': './data/H_slab/DS/valid/images/',
    'class_names': ('slab'),
    'label_map': {1: 1}
})
...
slab_dataset = dataset_base.copy({
    ...
    'train_images': './data/H_slab/WS/train/images/',
    'valid_info': './data/H_slab/WS/valid/WS_VALID_100.json',
    'valid_images': './data/H_slab/WS/valid/images/',
    'class_names': ('slab'),
    'label_map': {1: 1}
})
'''
...
yolact_resnet50_slab_config = yolact_resnet50_config.copy({
    'name': 'yolact_plus_resnet50_slab',
    # Dataset stuff
    'dataset': slab_dataset,
    'num_classes': len(slab_dataset.class_names) + 1,

...
#parser.add_argument('--config', default='yolact_resnet50_cig_butts_config',
#                    help='The config object to use.')
...
def train():
    ...
    data_loader = data.DataLoader(dataset, args.batch_size,
                                  ...
                                  shuffle=False, collate_fn=detection_collate,   #KDG shuffle=True
                                  pin_memory=True)

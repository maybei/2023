...
def parse_args(argv=None):
    ...
    parser.add_argument('--trained_model',
                        default='./weights/yolact_plus_resnet50_slab_98_38000.pth', type=str,
    ...
    #                     default='./data/slab/H_P/ORIGINAL/21_10_23?RESULTIMAGES/output_images_H_21_10_23_TOP2',
    #                     type=str,
    parser.add_argument('--images', default=edit_path, type=str,
...
def prep_display(dets_out, img, h, w, undo_transform=True, class_color=False, mask_alpha=0.45, fps_str=''):
    ...
    if args.display_masks and cfg.eval_mask_branch:
        ...
        colors = torch.cat([torch.FloatTensor(get_color(j, on_gpu=img.device.index)).view(1, 1, 1, 3) for j in
    ...
    if args.display_text or args.display_bboxes:
        for j in reversed(range(num_dets_to_consider)):
            ...
            if args.display_text:
                ...
                file.write(imageName + "[" + str(score) + '] , [ ' + str(g_x1) + ' , ' + str(g_x2) + ' , ' + str(
                    g_y1) + ' , ' + str(g_y2) + " ] " + "\n")
                file.close()
    return img_numpy
